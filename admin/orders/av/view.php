...
// Check if user has permission to view orders (superadmin, accounts, or client)
$userRole = $_SESSION['role'] ?? '';
...
// Get order data
global $pdo;
$stmt = $pdo->prepare("SELECT * FROM orders_av WHERE id = ?");
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h3>View AV Order: <?php echo htmlspecialchars($order['id']); ?></h3>
                <a href="../list.php" class="btn btn-sm btn-secondary">Back to Orders</a>
            </div>
            <div class="card-body">
                <div class="alert alert-info">
                    <p>Audio/Video order details are under development.</p>
                    <p>Order ID: <?php echo htmlspecialchars($order['id']); ?></p>
                    <p>Locked: <?php echo $order['locked'] ? 'Yes' : 'No'; ?></p>
